...
class GaussianDiffusion(SchedulerMixin, ConfigMixin):
    """
    ...
    def __init__(
        ...
        *,
        ...
        betas = get_named_beta_schedule(beta_schedule, num_train_timesteps)
    ...
    def _vb_terms_bpd(
        ...
        """
        # true_mean: noisy sample,
        # true_log_var = log(variance) from scheduler
